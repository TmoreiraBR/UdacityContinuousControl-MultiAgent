...
<img src="https://render.githubusercontent.com/render/math?math=L(\theta) = \hatE_{(s,a,r,s')}[sum(r',  \gamma \hat{q}(s',\mu(s', \phi_{frozen}),\theta_{frozen})) - \hat{q}(s,a,\theta)]^2">,
...
<img src="https://render.githubusercontent.com/render/math?math=J(\phi) = \hatE_{(s)}[\hat{q}_{\pi}(s, \mu(s, \phi), \theta)]">.
